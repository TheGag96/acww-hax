...
mixin FUNC!("ChangePlayerEquipment", 0x02094448, InstructionSet.thumb, bool function(Equipment, u32));
mixin FUNC!("GetInventoryObject",    0x02097264, InstructionSet.thumb, Inventory* function());
mixin FUNC!("GetInventoryItemList",  0x02097cc4, InstructionSet.thumb, ItemId[INVENTORY_SIZE]* function(InventorySub*, size_t));
mixin FUNC!("GetPlayerEquipment",    0x020984a0, InstructionSet.thumb, ItemId* function(Inventory* inventory));
mixin FUNC!("GetInventorySub",       0x020984ac, InstructionSet.thumb, InventorySub* function(Inventory* inventory));
mixin FUNC!("SetPlayerEquipment",    0x02098494, InstructionSet.thumb, void function(Inventory*, ItemId*));
...
enum Button* gInputHeld = cast(Button*) 0x021F4258;
enum Button* gInputDown = cast(Button*) 0x021F425A;
